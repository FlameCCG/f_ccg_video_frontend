  ...
  <Teleport to="body">
    ...
    >
      ...
      <div 
        ...
        @click.stop
      >
        <button class="hover:text-white transition-colors p-1" title="放大 (滚轮上)" @click="handleZoomIn">
          <ZoomIn class="h-5 w-5" />
        </button>
        <button class="hover:text-white transition-colors p-1" title="缩小 (滚轮下)" @click="handleZoomOut">
